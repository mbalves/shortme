...
public class GlobalErrorHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<ErrorDetails> handleBadUrlException(UrlNotFoundException ex, WebRequest request) {
        return buildResponse(ex.getMessage(),ex.getUrlId(), HttpStatus.NOT_FOUND);
    }
